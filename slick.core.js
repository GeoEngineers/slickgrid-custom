...
(function ($, window) {
   ...
   * @param {Number} [toRow=fromRow]. Ending row. Defaults to <code>fromRow</code>.
   * @param {Number} [toCell=fromCell]. Ending cell. Defaults to <code>fromCell</code>.
   */
  ...
  function EditorLock() {
     ...
     * @method isActive
     * @param {Object} [editController = activeEditController] editController
     * @return {Boolean}
     */
     ...
     * @method activate
     * @param {Object} [editController=activeEditController] Edit controller object acquiring the lock
     */
     ...
     * @method deactivate
     * @param {Object} editController Edit controller object releasing the lock
     */

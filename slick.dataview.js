(function ($, window) {
   ...
   * @param {Slick.Data.GroupItemMetadataProvider}  options.groupItemMetadataProvider   Group Item Metadata provider.
   * @param {Boolean}  [options.inlineFilters=false]    Flag to indicate presence of inline filters in the view.
   */
  function DataView(options) {
    ...
    function groupBy(valueGetter, valueFormatter, sortComparer) {
      if (!valueGetter || valueGetter === null) {
        setGrouping([]);
        return;
      }
  ...
  function MinAggregator(field) {
    ...
    this.accumulate = function (item) {
      var val = item[this.field_];
      if (val && val !== null && val !== "" && !isNaN(val)) {
        if (this.min_ === undefined || this.min_ === null || val < this.min_) {
          this.min_ = val;
        }
      }
    };

(function ($, window) {
  ...
  /**
   * Selection model based on a checkbox column for multiple row selection.
   *
   * @param {Object} options    Plugin options.
   * @param {String}  [options.columId="_checkbox_selector"]   ID of the column containing checkboxes.
   * @param {String}  options.cssClass   CSS Class to provide to the column DOM.
   * @param {String}  [options.toolTip="Select/Deselect All"]   Tooltip text for header checkbox.
   * @param {Number}  [options.width=30]   Column width.
   * @constructor
   */

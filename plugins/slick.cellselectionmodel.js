(function ($, window) {
  ...
  /**
   * Modelling selection of cells for further processing.
   *
   * @param {Object}  options   Plugin options
   * @param {Object} options.selectionCss   CSS Hash to pass to the selected cells.
   * @param {Object} options.selectActiveCell [true]   Boolean to indicate the currently active cell is also selected.
   * @constructor
   */
